...
export function loadModels(loader, scene, world) {
    ...
    loader.load('/lion_statue.glb', function (gltf) {
        ...
        lionStatueModel.position.set(0, 0, 0);
...
// loader.load('./coconut_tree/scene.gltf', function (gltf) {
//     const coconutTreeModel1 = gltf.scene;
//     coconutTreeModel1.scale.set(0.1, 0.1, 0.1);
//     coconutTreeModel1.position.set(0, 0, 0);

//     scene.add(coconutTreeModel1);

//     const coconutTreeModel2 = coconutTreeModel1.clone();

//     coconutTreeModel2.position.set(-100, 0, 0); // Adjust the position as needed
//     scene.add(coconutTreeModel2);
